...
`,
  ...
  ${c('cyan', '──────────────────')}
  Add your own tools by dropping .js files into ${c('gray', '~/.forge-ide/tools/')}
  ...
  (creates ${c('gray', '~/.forge-ide/tools/my_tool.js')} with example code)
...
`,
  ...
  ${cb('white', 'PERMANENT CONFIG (edit ~/.forge-ide/config.json):')}
  ${cb('white', '{')}
